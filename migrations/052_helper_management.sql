-- ============================================================================
-- Migration: 052_helper_management
-- Description: Helper Management module - salary fields, holidays, payslips
-- ============================================================================

-- ============================================================================
-- PART 1: Add Helper-specific columns to users table
-- ============================================================================
ALTER TABLE users 
ADD COLUMN IF NOT EXISTS helper_start_date DATE,
ADD COLUMN IF NOT EXISTS helper_base_salary INTEGER DEFAULT 5100,
ADD COLUMN IF NOT EXISTS helper_food_allowance INTEGER DEFAULT 1236,
ADD COLUMN IF NOT EXISTS helper_other_allowances JSONB DEFAULT '[]'::jsonb;

-- ============================================================================
-- PART 2: Create HK Statutory Holidays reference table
-- ============================================================================
...
-- ============================================================================
-- PART 3: Create helper_holiday_records table
-- ============================================================================
...
-- ============================================================================
-- PART 4: Create helper_payslip_confirmations table
-- ============================================================================
